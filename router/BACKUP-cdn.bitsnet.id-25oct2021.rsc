# oct/25/2021 15:54:54 by RouterOS 6.47.9
...
add in-filter=eBGP-CD-IX-IN instance=BITSNET name=CD-IX-2 out-filter=\
    ...
    remove-private-as=yes ttl=default
add in-filter=eBGP-APJI-IIX-in instance=BITSNET name=\
    IIX-APJII-BrocadeMLXe-16CSF nexthop-choice=force-self out-filter=\
...
add in-filter=eBGP-APJI-IIX-in instance=BITSNET name=\
    ...
    remove-private-as=yes ttl=default
add in-filter=eBGP-APJI-IIX-in instance=BITSNET name=IIX-APJII-RouterJuniper \
    nexthop-choice=force-self out-filter=eBGP-APJI-IIX-out remote-address=\
    103.28.74.129 remote-as=7597 remove-private-as=yes ttl=default
...
add comment="IP REMOTE ADDRESS TIDAK AKTIF/TIDAK BISA DI PING" in-filter=\
    eBGP-ALIBABA-in instance=BITSNET name=AS3856-PCH nexthop-choice=\
    force-self out-filter=eBGP-ALIBABA-out remote-address=103.28.74.236 \
    remote-as=3856 remove-private-as=yes ttl=default
...
add comment="JANGAN DIENABLE" in-filter=eBGP-APJI-IIX-in instance=BITSNET \
    name=EBGP-Cloudflare nexthop-choice=force-self out-filter=\
    eBGP-APJI-IIX-out remote-address=103.28.75.135 remote-as=13335 \
    remove-private-as=yes ttl=default update-source=2100-BITS-IIX
add comment="JANGAN DIENABLE" in-filter=eBGP-JKT-IIX-in instance=BITSNET \
    name=EBGP-Cloudflare-2 nexthop-choice=force-self out-filter=\
    eBGP-JKT-IIX-out remote-address=119.11.184.14 remote-as=13335 ttl=default \
...
add in-filter=eBGP-ALIBABA-in instance=BITSNET name=EBGP-Amazon-JKTIX \
    ...
    remove-private-as=yes ttl=default
add comment="JANGAN DIENABLE" disabled=yes in-filter=eBGP-RAPID-IN instance=\
    BITSNET name=RAPID-TELKOM out-filter=eBGP-RAPID-OUT remote-address=\
    10.210.1.118 remote-as=141137 remove-private-as=yes ttl=default
add in-filter=eBGP-NICE-IN instance=BITSNET name=OPENIXP nexthop-choice=\
    force-self out-filter=eBGP-NICE-OUT remote-address=218.100.27.128 \
    remote-as=7717 remove-private-as=yes ttl=default
add in-filter=eBGP-ALIBABA-in instance=BITSNET name=EBGP-Tencent-OIXP \
    out-filter=eBGP-ALIBABA-out remote-address=218.100.36.246 remote-as=\
    132203 remove-private-as=yes ttl=default update-source=*1B
add in-filter=eBGP-ALIBABA-in instance=BITSNET name=EBGP-Akamai-JKTIX \
    ...
    remove-private-as=yes ttl=default
add in-filter=eBGP-APJI-IIX-in instance=BITSNET name=IIX-APJII-Server-1 \
    nexthop-choice=force-self out-filter=eBGP-APJI-IIX-out remote-address=\
    103.28.74.222 remote-as=7597 remove-private-as=yes ttl=default
add in-filter=eBGP-APJI-IIX-in instance=BITSNET name=IIX-APJII-Server-2 \
    nexthop-choice=force-self out-filter=eBGP-APJI-IIX-out remote-address=\
    103.28.75.222 remote-as=7597 remove-private-as=yes ttl=default
add in-filter=eBGP-ALIBABA-in instance=BITSNET name=EBGP-Tencent-IIX \
    out-filter=eBGP-ALIBABA-out remote-address=103.28.74.204 remote-as=132203 \
    remove-private-as=yes ttl=default update-source=*1B
/routing filter
