# nov/26/2021 23:14:41 by RouterOS 6.46.7
...
add name=bridge-KGX-JATIBARANG
add name=bridge-KGX-MAJALENGKA
add name=loopback
/interface ethernet
...
add local-address=10.254.1.1 mac-address=02:8C:34:25:9F:BB name=\
    EoIP-KGX-JATIBARANG remote-address=10.254.1.56 tunnel-id=5544
add local-address=10.254.1.1 mac-address=02:8C:34:25:9F:BB name=\
    EoIP-KGX-MAJALENGKA remote-address=10.254.1.55 tunnel-id=55555
/interface gre
...
add action=dst-nat chain=dstnat comment="redirect dns 1 to dns 2" disabled=\
    yes dst-address=103.19.56.2 dst-port=53 nth=2,1 protocol=udp \
    to-addresses=9.9.9.9 to-ports=53
add action=dst-nat chain=dstnat comment="redirect dns 1 to dns 2" disabled=\
    yes dst-address=103.19.56.3 dst-port=53 protocol=udp to-addresses=\
...
/ip route
add disabled=yes distance=1 gateway=103.19.56.185
add disabled=yes distance=1 gateway=103.19.56.185
add check-gateway=ping comment="Classmild Tulungagung" distance=109 \
    dst-address=103.19.56.52/30 gateway=103.19.59.172
add check-gateway=ping comment=BACKUP-KARANTINABDG disabled=yes distance=2 \
    dst-address=103.19.56.96/29 gateway=172.16.101.2
add check-gateway=ping comment="Route to Aston Via Telkom" distance=111 \
    dst-address=103.19.56.208/30 gateway=172.16.101.42
add check-gateway=ping comment=BACKUP-PTSELIM distance=111 dst-address=\
    103.19.57.152/29 gateway=172.16.101.26
...
add comment=BTN-IMY local-address=10.254.1.1 name=BTN-IMY password=BTN-IMY \
    remote-address=10.254.1.30
