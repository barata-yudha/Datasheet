...
add interface=sfp-sfpplus1 name=504-DIST1-OLD vlan-id=504
...
add interface=sfp-sfpplus1 name=952-XL-KETAHUN vlan-id=952
add interface=sfp-sfpplus1 name=1106-TO-IX vlan-id=1106
add interface=sfp-sfpplus1 name=1117-TO-CDN vlan-id=1117
...
add interface=ether6 name=1801-TO-DISTRIBUSI-1-JUNOS vlan-id=1801
...
add address=10.11.168.1/29 interface=952-XL-KETAHUN network=10.11.168.0
