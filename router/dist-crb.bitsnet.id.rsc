...
set [ find default-name=ether3 ] comment=EX-BACKBONE-IFORTE-1G
...
add comment=IPIP-TUNEL local-address=103.19.56.151 mtu=1500 name=\
    tun01-gronggong-main-microwave remote-address=10.10.11.34
add allow-fast-path=no !keepalive local-address=103.19.56.151 mtu=1500 name=\
    tun02-silihasah1 remote-address=10.5.2.43
...
add allow-fast-path=no !keepalive local-address=103.19.56.151 name=\
    tun12-karantina remote-address=10.10.10.107
add allow-fast-path=no !keepalive local-address=103.19.56.151 name=\
    tun13-danalampah remote-address=10.5.2.34
add !keepalive local-address=103.19.56.151 name=tun14-Bagja remote-address=\
    10.2.5.2
...
add comment="pindah ke junos" disabled=yes max-limit=60M/60M name=\
    "IMY - YUSUF" target=103.19.57.248/30
...
add disabled=yes max-limit=15M/15M name="DEDICATED - Corporate Kejar" target=\
    103.19.57.28/30
add disabled=yes max-limit=15M/15M name=\
    "DEDICATED - Corporate PT Anugrah Gerbang Emas" target=103.19.57.34/32
add disabled=yes max-limit=2M/2M name="DEDICATED - Corporate Samsat" target=\
    103.19.57.20/30
...
add disabled=yes max-limit=30M/30M name="DEDICATED - Hotel Amaris Cirebon" \
    target=103.19.57.240/29
add comment=100 disabled=yes max-limit=40M/40M name=\
    "Hotel Citra Dream Cirebon" target=103.19.57.24/32
add disabled=yes max-limit=400M/400M name="IMY - CANDRA" target=\
    103.19.57.224/30
add comment="LIMIT DI SWITCH" disabled=yes max-limit=50M/50M name=\
    "IMY - CECEP Site Majalengka" target=103.19.57.164/30
add comment="pindah ke junos" disabled=yes max-limit=85M/85M name=\
    "IMY - HARDI" target=103.19.57.136/30
add comment="pindah ke junos" disabled=yes max-limit=85M/85M name=\
    "IMY - KRISYANTO" target=103.19.57.200/30
add comment="pindah ke junos" disabled=yes max-limit=93M/93M name=\
    "IMY - NATA" target=103.19.58.120/29
add comment="LIMIT DI SWITCH" disabled=yes max-limit=50M/50M name=\
    "IMY - WARIDI" target=103.19.57.108/30
add comment="pindah ke junos" disabled=yes max-limit=93M/93M name=\
    "IMY - NURIN" target=103.19.57.184/30
add comment="LIMIT DI SWITCH" disabled=yes max-limit=605M/605M name=\
    "IMY - RIONET" target=103.19.57.148/30
add max-limit=20M/20M name=RB-MONITORING-LISTRIK-KERTASMAYA target=\
    172.16.1.36/30
add comment="pindah ke junos" disabled=yes max-limit=83M/83M name=\
    "IMY - TARUNA" target=103.19.57.160/30
...
add burst-limit=50M/50M burst-threshold=19M/19M burst-time=1m30s/1m30s \
    ...
    103.19.57.20/32
add max-limit=10M/10M name="SOHO 3M - GROUP1" target=\
    172.16.1.32/30,103.19.57.10/32 total-priority=1
add max-limit=15M/15M name="SOHO 5M GROUP-1" target=\
    172.16.2.4/30,172.16.2.92/30,172.16.2.84/30
add max-limit=40M/40M name="SOHO 30M GROUP-1" target=\
    172.16.1.212/30,172.16.1.220/30
add max-limit=100M/100M name="SOHO 10M GROUP-1" target=\
    103.19.57.25/32,103.19.57.16/32,103.19.57.23/32
add max-limit=30M/30M name="SOHO 10M GROUP-2" target=\
    172.16.2.96/30,172.16.2.8/30,103.19.57.33/32
add max-limit=3M/3M name="SOHO 3M - MITRA 10" parent="SOHO 3M - GROUP1" \
    target=103.19.57.10/32 total-priority=1
add max-limit=3M/3M name="SOHO 5M - SDN SILIHASAH 1" parent=\
    "SOHO 5M - PENDIDIKAN" target=172.16.2.16/30
add max-limit=10M/10M name="SOHO 5M - SDN Cadasngampar" parent=\
...
add max-limit=10M/10M name="SOHO 10M - KBL-TW" parent="SOHO 10M GROUP-2" \
    priority=1/1 target=103.19.57.33/32
add max-limit=10M/10M name="SOHO 10M - Ivan Sutanto" parent=\
    "SOHO 10M GROUP-2" priority=1/1 target=172.16.2.8/30
add max-limit=10M/10M name="SOHO 10M - Hotel Sapadia" parent=\
    "SOHO 10M GROUP-1" target=103.19.57.25/32
add comment="BOD 100M" max-limit=35M/35M name="SOHO 10M - Hotel Sutan Raja" \
...
add interface=1510-FIBERSTAR list=backbone
add interface=1513-IFORTE-NEW list=backbone
/interface pptp-server server
set authentication=pap,chap,mschap1,mschap2
/ip address
add address=172.16.1.177/30 interface=tun02-silihasah1 network=172.16.1.176
add address=172.16.1.49/30 interface=tun06-tiki network=172.16.1.48
add address=172.16.1.209/30 interface=tun05-lebakngok network=172.16.1.208
add address=172.16.1.13/30 interface=tun10-ivansutanto network=172.16.1.12
...
add address=10.10.10.9/29 interface=202-CDH-BAHAMA network=10.10.10.8
add address=10.10.10.89/29 interface=213-CDH-CENDANA network=10.10.10.88
add address=10.10.10.105/29 interface=233-CDH-KARANTINA network=10.10.10.104
add address=10.10.10.113/29 interface=216-CDH-SUTANRAJA network=10.10.10.112
add address=10.10.10.161/29 interface=221-CDH-BBWS network=10.10.10.160
add address=10.10.10.185/29 interface=223-CDH-KEJARBANK network=10.10.10.184
...
add address=172.16.1.57/30 interface=tun01-gronggong-main-microwave network=\
    172.16.1.56
add address=172.16.1.61/30 interface="tun03-albahjah(backup)" network=\
    172.16.1.60
...
add address=103.19.57.8 interface=239-CDH-CORE-BPR network=103.19.57.15
...
add address=103.19.57.8 interface=259-GOESAR-METLANDHOTEL network=\
    103.19.57.21
add address=103.19.57.8 interface=237-CDH-PT-ANUGRAH network=103.19.57.34
add address=103.19.57.8 interface=615-TIS-TSM network=103.19.57.22
add address=103.19.57.8 interface=216-CDH-SUTANRAJA network=103.19.57.23
add address=103.19.57.8 interface=205-CITRADREAMHOTEL network=103.19.57.24
add address=103.19.57.8 interface=206-CDH-SAPADIAHOTEL network=103.19.57.25
add address=103.19.57.8 comment=DKIS-DEDICATED-IX interface=\
...
add address=172.16.2.8/30 comment="IVAN SUTANTO" list=ip-soho
...
add address=10.202.0.130 list=ns-bitsnet
...
add address=10.5.2.2 comment="SD ARGASUNYA" list=ip-soho
...
add address=172.16.1.74 comment=TSM list=ip-soho
...
add address=172.16.1.32/30 comment="MAMAN PURI" list=ip-soho
add address=10.10.10.232/29 comment=ST-GRG list=ip-soho
add address=10.200.0.25 comment=AP-GRG list=ip-soho
add address=172.16.1.75 comment=RB-MON-CDH list=ip-soho
...
add address=103.105.142.0/24 comment=DKIS list=whitelist
add address=103.19.56.88/30 comment=DKIS list=whitelist
add address=103.105.142.224/27 comment=DKIS list=whitelist
add address=10.10.11.32/29 comment=gronggong list=ip-soho
...
add address=172.16.1.96/30 comment="Backup RadioQu" list=ip-soho
...
add action=mark-packet chain=forward comment="ICMP DOWN" connection-mark=ICMP \
    disabled=yes in-interface-list=all new-packet-mark="ICMP DOWN" \
    passthrough=yes
add action=mark-packet chain=forward comment="ICMP UP" connection-mark=ICMP \
    disabled=yes new-packet-mark="ICMP UP" out-interface-list=all \
    passthrough=no
add action=mark-packet chain=prerouting comment=DNS disabled=yes dst-port=53 \
    new-packet-mark=dns passthrough=no protocol=udp
/ip firewall nat
add action=dst-nat chain=dstnat comment="Redirect DNS" disabled=yes \
    dst-address-list=!dns-bitsnet dst-port=53,5353,5355,443,853 nth=2,1 \
    protocol=udp src-address-list=network-bitsnet to-addresses=103.19.56.10 \
    to-ports=53
add action=dst-nat chain=dstnat comment="Redirect DNS" disabled=yes \
    dst-address-list=!dns-bitsnet dst-port=53,5353,5355,443,853 nth=1,1 \
    protocol=udp src-address-list=network-bitsnet to-addresses=103.19.56.11 \
    to-ports=53
...
add action=dst-nat chain=dstnat comment="Radio ST Cust. PDA Net" dst-address=\
    ...
    to-ports=80
add action=dst-nat chain=dstnat comment="CERAGON TRISI ( WEB )" dst-address=\
    103.19.56.218 dst-port=8881 protocol=tcp to-addresses=10.10.11.66 \
    to-ports=80
add action=dst-nat chain=dstnat comment="CERAGON TRISI ( SSH )" dst-address=\
    103.19.56.218 dst-port=8882 protocol=tcp to-addresses=10.202.0.6 \
    to-ports=22
add action=dst-nat chain=dstnat comment="CERAGON TRISI ( SSH )" dst-address=\
...
add comment="Route to Purimulya" distance=1 dst-address=10.2.0.0/16 gateway=\
    103.19.57.14
add comment="Route to Sumber" distance=1 dst-address=10.3.0.0/16 gateway=\
    10.10.10.91
add comment="Route to Karantina" distance=1 dst-address=10.4.0.0/16 gateway=\
    10.10.10.107
add check-gateway=ping comment="Route to Gronggong via Microwave" distance=1 \
    dst-address=10.5.0.0/16 gateway=10.10.11.34
add check-gateway=ping comment="Route to Gronggong via Cambium EPMP" \
    distance=2 dst-address=10.5.0.0/16 gateway=10.10.10.235
add check-gateway=ping comment="Route to Gronggong via Microwave" distance=1 \
    dst-address=10.5.12.0/24 gateway=103.19.56.217
add check-gateway=ping comment="Route to Gronggong via Microwave" distance=1 \
...
add check-gateway=ping comment="TSM Backup Via CDH" distance=2 dst-address=\
    103.19.57.22/32 gateway=172.16.1.74
add check-gateway=ping comment="Route to Tiki" distance=1 dst-address=\
...
add check-gateway=ping comment="Route To KBL" distance=1 dst-address=\
    103.19.57.33/32 gateway=172.16.1.110
add check-gateway=ping comment="Route To KBL" distance=2 dst-address=\
...
add check-gateway=ping comment="Route to Jasamarga / Backup Wireless" \
    distance=2 dst-address=103.19.57.76/30 gateway=172.16.1.102
add comment="Route to Sutan Raja Hotel" distance=1 dst-address=\
    103.19.57.88/30 gateway=10.10.10.115
add comment="Route to Cendana " distance=1 dst-address=103.19.57.112/30 \
    gateway=10.10.10.90
...
add distance=1 dst-address=103.19.57.206/32 gateway=172.16.1.114
add comment="KHAS KEMPEK" distance=1 dst-address=103.19.57.207/32 gateway="172\
    .16.1.250,172.16.1.250,172.16.1.250,172.16.1.254,172.16.1.254,172.16.1.254\
    "
add comment="Route to Karantina" distance=1 dst-address=103.19.57.216/30 \
    gateway=172.16.1.22
...
add check-gateway=ping distance=1 dst-address=172.16.1.120/30 gateway=\
    172.16.1.114
add distance=2 dst-address=172.16.1.120/30 gateway=172.16.1.98
add comment=YOGI-MTH distance=1 dst-address=172.16.1.212/30 gateway=\
    103.19.57.32
add distance=1 dst-address=172.16.1.244/30 gateway=172.16.1.250,172.16.1.254
add comment="Route to Almaun" distance=1 dst-address=172.16.2.4/30 gateway=\
    172.16.1.30
add check-gateway=ping comment="Route To Ivan Sutanto" distance=1 \
    dst-address=172.16.2.8/30 gateway=172.16.1.14
add check-gateway=ping comment="Route To Ivan Sutanto" distance=2 \
    dst-address=172.16.2.8/30 gateway=10.10.11.34
add comment="Route To Ivan Sutanto" distance=3 dst-address=172.16.2.8/30 \
    gateway=10.10.10.235
add check-gateway=ping comment="Route to Silih Asah1" distance=1 dst-address=\
    172.16.2.16/30 gateway=172.16.1.178
add comment="Route to Silih Asah1" distance=1 dst-address=172.16.2.16/30 \
    gateway=10.10.11.34
add comment="Route to Silih Asah1" distance=2 dst-address=172.16.2.16/30 \
    gateway=10.10.10.235
add comment="Route to Lebakngok" distance=1 dst-address=172.16.2.20/30 \
    gateway=172.16.1.210
add comment="Route to Lebakngok" distance=1 dst-address=172.16.2.22/32 \
    gateway=172.16.1.210
add check-gateway=ping comment="Route to Argasunya" distance=1 dst-address=\
    172.16.2.24/30 gateway=10.10.11.34
add comment="Route to Argasunya" distance=2 dst-address=172.16.2.24/30 \
    gateway=10.10.10.235
add comment="Route To Makrus Motor Pilang Sari" disabled=yes distance=1 \
    dst-address=172.16.2.32/30 gateway=10.10.10.202
add comment="Route to BACKUP-AL-BAHJAH" distance=1 dst-address=172.16.2.36/30 \
    gateway=172.16.1.62
...
add comment="Route to Desa danalampah" distance=1 dst-address=172.16.2.84/30 \
    gateway=172.16.1.18
add check-gateway=ping comment="Rb Monitoring listrik gronggong" distance=1 \
    dst-address=172.16.2.88/30 gateway=10.10.11.34
add comment="Rb Monitoring listrik gronggong" distance=2 dst-address=\
    172.16.2.88/30 gateway=10.10.10.235
...
add action=accept chain=ospf-in prefix=100.64.0.0/10 prefix-length=10-32
...
add action=accept chain=ospf-in disabled=yes prefix=103.19.56.0/23 \
    prefix-length=23-24
add action=accept chain=ospf-in disabled=yes prefix=103.19.58.0/23 \
    prefix-length=23-24
...
add interval=3d name=autobackup&autosend on-event="/system backup save name=(\
    ...
    start-time=startup
/system script
add dont-require-permissions=no name=autobackup&autosend owner=ageng policy=\
...
/tool romon
set enabled=yes secrets=3XBHykz!St
